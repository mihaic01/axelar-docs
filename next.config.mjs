...
export default nextra({
  ...
  redirects: () => {
    return [
      ...
      {
        source: '/dev/build/chain-names',
        destination: '/dev/reference/chain-names',
        permanent: true,
      },
      {
        source: '/dev/build/chain-names/:path(.*)',
        destination: '/dev/reference/chain-names/:path',
        permanent: true,
      },
      {
        source: '/dev/build/contract-addresses/:path(.*)',
        destination: '/dev/reference/contract-addresses/:path',
        permanent: true,
      },
      {
